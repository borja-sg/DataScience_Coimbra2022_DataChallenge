...
"""
This script read a data set specified in a configuration file and test a CNN.
...
filename_Xtest = '/lstore/lattes/borjasg/DataScienceSchool/DataScience/input_1x_S2.txt'
filename_Ytest = '/lstore/lattes/borjasg/DataScienceSchool/DataScience/output_1x_s2.txt'

#data = pd.read_csv(filename)
#data.describe()


X_test = np.loadtxt(filename_Xtest)
Y_test = np.loadtxt(filename_Ytest)


traceLength = X_test.shape[1]
...
#Read model to test
estimator = load_model("/home/cosmo/borjasg/projects/DataScience/models/CNN1_50epo.h5")

#Predict train and plot
pred_model = estimator.predict(X_test.reshape((X_test.shape[0], 1, traceLength)))
...
pred_model=pred_model.reshape(-1)

error_model = pred_model-Y_test



#Plots
name_to_plot = "./imgs/test_dataset2/error_test_histogram.pdf"
name_label = r"$d_{\rm reco}-d_{\rm sim}$"

plot_simple_histogram(data1=error_model,plotname=name_to_plot,name1="Test",xlabel_title=name_label)


name_to_plot = "./imgs/test_dataset2/Pred_test_histogram.pdf"
name_label = r"$d_{\rm reco}$"
plot_simple_histogram(data1=pred_model,plotname=name_to_plot,name1="Test",xlabel_title=name_label)


name_to_plot = "./imgs/test_dataset2/Y_test_histogram.pdf"
name_label = r"$d_{\rm sim}$"
plot_simple_histogram(data1=Y_test,plotname=name_to_plot,name1="Test",xlabel_title=name_label)

#Plots
name_to_plot = "./imgs/test_dataset2/error_test_histogram_gaussian.pdf"
name_label = r"$d_{\rm reco}-d_{\rm sim}$"

plot_simple_histogram(data1=error_model,plotname=name_to_plot,name1="Test",xlabel_title=name_label,plot_gaussian=True)
